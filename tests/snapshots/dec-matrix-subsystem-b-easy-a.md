...
## Matrix subsystem-b / easy-a

**Decision ID:** dec-matrix-subsystem-b-easy-a
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 39)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 39)
