...
## Matrix systemwide-b / hard-b

**Decision ID:** dec-matrix-systemwide-b-hard-b
**Date:** 2025-01-10T00:00:00.000Z
**Type:** architecture
**Scope:** systemwide

## Scores
- Overall Confidence: 14
- Reversibility: 0
- Blast Radius: 5
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 13)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 13)
