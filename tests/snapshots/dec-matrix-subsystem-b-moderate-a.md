...
## Matrix subsystem-b / moderate-a

**Decision ID:** dec-matrix-subsystem-b-moderate-a
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 36)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 36)
