...
## Matrix subsystem-b / moderate-b

**Decision ID:** dec-matrix-subsystem-b-moderate-b
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 32)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 32)
