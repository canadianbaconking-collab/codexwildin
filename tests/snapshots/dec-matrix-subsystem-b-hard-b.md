...
## Matrix subsystem-b / hard-b

**Decision ID:** dec-matrix-subsystem-b-hard-b
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 23)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 23)
