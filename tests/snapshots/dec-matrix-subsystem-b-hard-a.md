...
## Matrix subsystem-b / hard-a

**Decision ID:** dec-matrix-subsystem-b-hard-a
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 30)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 30)
