...
## Matrix systemwide-a / hard-b

**Decision ID:** dec-matrix-systemwide-a-hard-b
**Date:** 2025-01-10T00:00:00.000Z
**Type:** architecture
**Scope:** systemwide

## Scores
- Overall Confidence: 19
- Reversibility: 15
- Blast Radius: 5
...
- Assumption 1: Team capacity is stable → Δ overall -1 (new overall 18)
- Assumption 2: Latency budget remains unchanged → Δ overall -1 (new overall 18)
